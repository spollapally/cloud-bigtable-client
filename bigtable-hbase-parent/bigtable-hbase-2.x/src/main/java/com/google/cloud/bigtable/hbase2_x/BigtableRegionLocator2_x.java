...
import com.google.cloud.bigtable.hbase2_x.adapters.SampledRowKeysAdapter2_x;

/**
 * <p>Exact copy Hbase 1.x class. Needed here as it is not binary compatible with Hbase 2.x.
 ...
 * @version $Id: $Id
 */
public class BigtableRegionLocator2_x implements RegionLocator {
  ...
  protected static final Logger LOG = new Logger(BigtableRegionLocator2_x.class);
   ...
   */
  public BigtableRegionLocator2_x(TableName tableName, BigtableOptions options, BigtableDataClient client) {
    ...
    this.adapter = new SampledRowKeysAdapter2_x(tableName, serverName);
  }
